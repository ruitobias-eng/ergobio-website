    ...
    <section id="sobre" className="py-24 bg-background transition-colors overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="space-y-6">
              {features.map((item, index) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="flex items-start gap-4 p-6 rounded-2xl bg-card border border-border hover:shadow-lg transition-all duration-300 group"
                >
          ...
          >
            {/* Main Card */}
            <div className="relative bg-gradient-to-br from-card to-muted rounded-3xl p-8 shadow-2xl border border-border overflow-hidden">
              {/* Background Pattern */}
              <div className="absolute inset-0 opacity-5">
                <div className="absolute inset-0 bg-gradient-to-br from-secondary to-contraste" />
              </div>
              ...
              <div className="relative z-10 text-center">
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="w-32 h-32 mx-auto mb-6 bg-gradient-to-br from-secondary to-contraste rounded-full flex items-center justify-center shadow-2xl border-4 border-background"
                >
              ...
              {/* Decorative Elements */}
              <div className="absolute top-4 right-4 w-4 h-4 bg-contraste rounded-full opacity-20" />
              <div className="absolute bottom-4 left-4 w-6 h-6 bg-secondary rounded-full opacity-20" />
            </div>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="absolute -top-4 -right-4 bg-gradient-to-r from-contraste to-orange-500 text-white px-4 py-2 rounded-xl shadow-lg font-semibold"
            >
              +10 anos Exp.
            </motion.div>
          </motion.div>
